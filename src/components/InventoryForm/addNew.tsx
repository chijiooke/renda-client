...
//                 {!showUploadButton && (
//                   <th className="">
// <div className="w-100 rounded-[0.75rem] text-white border-primary cursor-pointer border-2 p-3 bg-red-500 rounded-lg h-12 flex items-center justify-center">
...
//                 {index === formCount - 1 && showUploadButton && (
...
//   const initialShowUploadButton = true;
...
//   };
//   const handleProcessItemsClick = () => {
//     setFormCount(initialFormCount);
//     setShowUploadButton(initialShowUploadButton);
        ...
        <div>
          {
            <div className="flex justify-end bottom-4 right-4">
              <button
                className="flex items-center justify-center w-36 h-10 px-3 py-1.5 bg-black bg-opacity-50 rounded-md"
                onClick={() => router.push(DashBoardRoutes.INVENTORY_CONFIRM_INVENTORY)}
              >
                <p className="text-xs font-semibold leading-none text-white">
                  Process Items
                </p>
