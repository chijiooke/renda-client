export enum StateReducerActions {
  ...
  REMOVE_ITEM_FROM_DELIVERY_VAN_ORDER = "REMOVE_ITEM_FROM_DELIVERY_VAN_ORDER",
  UPDATE_SELECTED_INVENTORY_ITEMS_TO_ORDER = "UPDATE_SELECTED_INVENTORY_ITEMS_TO_ORDER",
  REMOVE_SELECTED_ORDER_FROM_VAN = "REMOVE_SELECTED_INVENTORY_ITEMS_FROM_VAN",
  ...
  SELECT_MULTIPLE_INVENTORY_ITEMS_TO_ORDER = "SELECT_MULTIPLE_INVENTORY_ITEMS_TO_ORDER",
  CLEAR_INVENTORY_ITEMS_TO_ORDER = "CLEAR_INVENTORY_ITEMS_TO_ORDER",
